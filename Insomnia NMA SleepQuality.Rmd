---
title: "Insomnia NMA"
subtitle: "Prepared by Virginia Chiocchia on 26th July, refers to a single outcome analysis (Sleep Quality) in a frequentist setting"
output: 
  word_document: 
    fig_height: 7
    fig_width: 10
...
# SQ    ### after romeving comparison with missing data network has 2 subnetworks
...
#network plot
netgraph(SQ1, plastic=F, thickness="number.of.studies", multiarm = F, points=T, col=1)
```
